...
set_target_properties(gloo PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/kevin/Downloads/pytorch/torch/lib/libgloo.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gloo )
list(APPEND _IMPORT_CHECK_FILES_FOR_gloo "/home/kevin/Downloads/pytorch/torch/lib/libgloo.a" )
...
set_target_properties(gloo_builder PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/home/kevin/Downloads/pytorch/torch/lib/libgloo_builder.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gloo_builder )
list(APPEND _IMPORT_CHECK_FILES_FOR_gloo_builder "/home/kevin/Downloads/pytorch/torch/lib/libgloo_builder.a" )
...
set_target_properties(gloo_cuda PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/home/kevin/Downloads/pytorch/torch/lib/libgloo_cuda.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gloo_cuda )
list(APPEND _IMPORT_CHECK_FILES_FOR_gloo_cuda "/home/kevin/Downloads/pytorch/torch/lib/libgloo_cuda.a" )
