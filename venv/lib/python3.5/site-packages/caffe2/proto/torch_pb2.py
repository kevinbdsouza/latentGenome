...
_PROTOVERSION = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='PROTO_VERSION_NEWEST', index=0, number=2,
      serialized_options=None,
      type=None),
  ],
...
_MODELDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='libs', full_name='torch.ModelDef.libs', index=5,
...
_MODELDEF.fields_by_name['libs'].message_type = _LIBDEF
