...
def testing_loop(cfg, track_cut, model, hidden_states, encoder_init, decoder_init):
    ...
    if decoder_init:
        ...
        decoder_hidden_init = hidden_states[2]
    ...
    for di in range(0, nValues):
        ...
        decoder_output, decoder_hidden, decoder_state = decoder(encoder_outputs[di].unsqueeze(0), decoder_hidden,
                                                                decoder_state)
    ...
    hidden_states[2] = decoder_hidden.squeeze(0).cpu().data.numpy()
...
if __name__ == '__main__':
    ...
    model_dir = '/home/kevindsouza/Documents/projects/latent/results/2019-02-27/model7/model'
