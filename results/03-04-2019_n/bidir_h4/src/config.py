...
class Config:
    def __init__(self):
        ...
        self.hidden_size_encoder = 2
        self.cell_assay_embed_size = self.hidden_size_encoder
        self.numdir = 2

        self.input_size_decoder = self.hidden_size_encoder * self.numdir
        ...
        self.model_dir = '/home/kevindsouza/Documents/projects/latent/src/saved_model/bidir'
