...
class Config:
    def __init__(self):
        ...
        self.epigenome_npz_path_train = '/opt/data/latent/data/npz/subset_test_5_celltypes/2_cells/z_norm_train'
        ...
        self.model_dir = '/home/kevindsouza/Documents/projects/latent/src/saved_model/z_norm_LN'
