...
class Model:
    ...
    def __init__(self, cfg, vocab_size):
        self.cfg = cfg
        self.encoder = encoder.EncoderLSTM(cfg, cfg.input_size_encoder, cfg.hidden_size_encoder).cuda().train()
        self.decoder = decoder.DecoderLSTM(cfg, cfg.input_size_decoder, cfg.hidden_size_decoder,
                                           cfg.output_size_decoder).cuda().train()
        self.ca_embedder = encoder.Embeddings(cfg, vocab_size)
