    ...
    for epoch_num in range(cfg.num_epochs):
        ...
        try:
            for track_cut in data_gen_train:
                ...
                rec_loss, hidden_states, encoder_init = training_loop(cfg, track_cut, model,
                                                                      encoder_optimizer,
...
def training_loop(cfg, track_cut, model, encoder_optimizer,
                  decoder_optimizer, criterion, hidden_states, encoder_init):
    ...
    return rec_loss.item() / nValues, hidden_states, encoder_init
